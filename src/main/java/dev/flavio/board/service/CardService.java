...
import static dev.flavio.board.persistence.entity.BoardColumnKindEnum.CANCEL;
import static dev.flavio.board.persistence.entity.BoardColumnKindEnum.FINAL;

import java.sql.Connection;
import java.sql.SQLException;
import java.util.List;

import dev.flavio.board.dto.BoardColumnInfoDTO;
import dev.flavio.board.exception.CardBlockedException;
import dev.flavio.board.exception.CardFinishedException;
import dev.flavio.board.exception.EntityNotFoundException;
import dev.flavio.board.persistence.dao.BlockDAO;
import dev.flavio.board.persistence.dao.CardDAO;
import dev.flavio.board.persistence.entity.CardEntity;
